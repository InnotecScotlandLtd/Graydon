...
return [
    ...
    'MONITORING_PROFILE_ID' => env('GRAYDON_MONITORING_PROFILE_ID'),
    ...
    'MONITORING_END_POINT' => env('GRAYDON_MONITORING_END_POINT','https://api.graydon.io/{country_id}/companies/monitoring/profiles/{profile_id}/events'),
    ...
    'MONITORING_SET_END_POINT' => env('GRAYDON_MONITORING_SET_END_POINT','https://api.graydon.io/{country_id}/companies/monitoring/profiles/{profile_id}/events'),
