...
return [
    ...
    'SEARCH_END_POINT'=>'https://api.graydon.io/{country_id}/companies',
    ...
    'MONITORING_END_POINT'=>'https://api.graydon.io/{country_id}/companies/monitoring/profiles/{profile_id}/events',
    ...
    'MONITORING_SET_END_POINT'=>'https://api.graydon.io/{country_id}/companies/monitoring/profiles/{profile_id}/events',
    ...
    'COMPANY_END_POINT'=>'https://api.graydon.io/{country_id}/companies/{company_id}/{other_uri}',
];